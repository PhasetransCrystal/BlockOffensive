...
import com.ptcrys.blockoffensive.map.OvertimeMode;
    ...
    public static class Common {
        ...
        private Common(ForgeConfigSpec.Builder builder) {
            ...
            builder.push("overtime");
            {
                ...
                ).defineEnum("overtimeMode", OvertimeMode.VOTE);
            ...
            builder.push("vote");
            {
                ...
                ).defineEnum("voteTimeoutPolicy", VoteObj.TimeoutPolicy.FAIL);
                ...
                ).defineEnum("voteAbstentionPolicy", VoteObj.AbstentionPolicy.COUNT_AS_NO);
