...
public class PingMarkerEntity extends Entity {
    ...
    private boolean isTeammateToLocalPlayer() {
        try {
            ...
            var localTeam = com.ptcrys.fpsmatch.common.client.FPSMClient.getGlobalData().getTeamByUUID(local.getUUID());
            var ownerTeam = com.ptcrys.fpsmatch.common.client.FPSMClient.getGlobalData().getTeamByUUID(owner);
