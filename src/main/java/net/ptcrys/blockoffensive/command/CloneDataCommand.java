...
final class CloneDataCommand {
    ...
    private static final SuggestionProvider<CommandSourceStack> CS_MAP_SUGGESTIONS = new FPSMCommandSuggests.FPSMSuggestionProvider((context, builder) -> FPSMCommandSuggests.getSuggestions(builder,
