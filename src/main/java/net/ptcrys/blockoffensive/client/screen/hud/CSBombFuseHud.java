 ...
 * 观战者游戏内 C4 引信倒计时 HUD。
 * <p>
 * 数据来自 {@link CSClientData#bombFuse}/{@link CSClientData#bombTotalFuse}（服务端 setFuse 每 tick 同步给观战者，
...
public final class CSBombFuseHud {
    ...
    public boolean isRendering() {
        if (!net.ptcrys.blockoffensive.BOConfig.client.spectatorBombHudEnabled.get()) {
            return false;
        }
    ...
    public void render(GuiGraphics graphics, ScreenRect bounds) {
        ...
        int danger = fraction < 0.25f ? withPulse(FPSMGuiTheme.ACCENT_DANGER, pulse) : FPSMGuiTheme.ACCENT_DANGER;
