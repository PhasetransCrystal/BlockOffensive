...
public final class CSHudSafeAreaLayouts {
    ...
    public static HudGeometry geometry(
        ...
        ScoreboardLayout scoreboardLayout = gameType == GameType.CS ? csScoreboard(screenWidth, screenHeight, leftPlayers, rightPlayers, expandedInfo) : csdmScoreboard(screenWidth, screenHeight, leftPlayers + rightPlayers);
        ...
        if (!spectator) {
            CombatInfoLayout combat = combatInfo(
                    ...
                    combatRightExtent,
                    combatHeight);
            Optional<MoneyLayout> money = gameType == GameType.CS ? Optional.of(money(screenWidth, screenHeight, moneyWidth, moneyHeight, combat.bounds())) : Optional.empty();
    ...
    public static TopStatusStack topStatusStack(
        ...
        Optional<ScreenRect> vote = voteVisible ? Optional.of(centered(screenWidth, nextY, VOTE_WIDTH, VOTE_HEIGHT)) : Optional.empty();
