...
import net.ptcrys.fpsmatch.common.client.camera.CameraFrame;
import net.ptcrys.fpsmatch.common.client.camera.CameraPose;
import net.ptcrys.fpsmatch.common.client.camera.CameraRig;
...
public record DeathCameraRig(Vec3 origin, Vec3 pullDirection, double maxPull,
        ...
        implements CameraRig {

    @Override
    public CameraFrame sample(double ticks) {
        float fall = smooth((ticks - DeathCameraTimeline.FALL_START_TICKS) / (DeathCameraTimeline.FALL_END_TICKS - DeathCameraTimeline.FALL_START_TICKS));
